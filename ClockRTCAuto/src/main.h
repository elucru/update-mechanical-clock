...
#define FINE_TIME_ADJUSTMENT            993     /* (us) stepper pulse for time precision. FINE_TIME_ADJUSTMENT + STEPPER_PULSE_TIME(ms) + STEPPER_DELAY_TIME(us) = 1 step time in (1/16) mode: 45ms -> 1 step*/
